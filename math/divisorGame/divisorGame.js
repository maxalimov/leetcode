...
// Thus Bob will get an even number. Now using the argument from Part 1 above,
// Bob can take this even number and keep giving an odd number back to Alice by subtracting 1.
// Thus Bob will always get to play even and Alice will always be stuck with an odd number smaller than her previous
// odd number after each round. Eventually Alice will have to play the number 1 and will lose the game since she will have
// no options.
// Thus, assuming both players play optimally, Alice will win the game if and only if she starts on an even number
// (i.e. N % 2 == 0).